...
--			ㄴ selsect를 기본키값으로 검색할 때 오직 1개의 행 결과가 조회됩니다.
...
--		ㄴ 외래키는 컬럼의 데이터가 참조값을(다른테이블 컬럼)을 사용하게 하는것이 목적입니다.
...
INSERT INTO IDEV.TBL_PRODUCT#(PCODE, CATEGORY, PNAME, PRICE)
VALUES('DOWON123a', 'B1', '동원참치', 54000);
INSERT INTO IDEV.TBL_PRODUCT#(PCODE, CATEGORY, PNAME, PRICE)
VALUES('dk_143', 'A2', '모션데스크', 234500);

-- 중요2 : 예를들면 PRICE, QUNTITY 등의 컬럼은 꼭 필수 데이터로 저장되어야 합니다.
...
INSERT INTO IDEV.TBL_BUY#(BUY_SEQ, CUSTOM_ID, PCODE, QUANTITY, BUY_DATE)
VALUES(tbl_buy_seq.nextval, 'min012', 'd_14', 1, sysdate);
