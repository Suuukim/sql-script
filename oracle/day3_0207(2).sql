...
--	  ㄴ 최대 2000바이트입니다. UTF-8 인코딩에서 한글은 3바이트, 영문/숫자/기호는 1바이트
...
--NCHAR2 타입 확인. :  고정길이, 단위는 문자개수., NCHAR 비교했을때 추가되는 공백 없습니다.
INSERT INTO table_string(ccol) VALUES ('abcdefghij');
...
INSERT INTO table_string(dcol) VALUES ('가나다라마바사아자차카');		--10글자는 OK, 11글자는 오류
